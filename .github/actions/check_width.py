...
def get_text_pixel_width(text, font_path=os.path.expanduser('~/.fonts/roboto.ttf'), font_size=10):
    # Use a truetype font
...
def main(event_name):
    ...
    font_path = os.path.expanduser('~/.fonts/roboto.ttf')  # Path to the Roboto truetype font file
